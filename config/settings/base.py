"""
Base Django settings for the payout management service.

These settings are shared between all environments; environment-specific
overrides live in ``local.py`` and ``production.py``.
"""
...
DATABASE_URL = env(
    "DATABASE_URL",
    default="postgres://postgres:postgres@localhost:5432/django_celery_payouts",
)
